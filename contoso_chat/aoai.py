# Adapted from Azure-Samples/assistant-data-openai-python-promptflow sample
# To support AOAI client setup we use these env variables setup by azd
#   AZURE_OPENAI_API_VERSION = api_version
#   AZURE_OPENAI_CHAT_DEPLOYMENT = chat model deployment name 
#   AZURE_OPENAI_ENDPOINT = chat model deployment ep
#   AZURE_OPENAI_NAME = chat model service name
#
import os
import logging
...
def get_azure_openai_client(
    ...
    # check if the api_version is provided or in the environment variables
    assert (
        api_version is not None or "AZURE_OPENAI_API_VERSION" in os.environ
    ), "api_version is None, AZURE_OPENAI_API_VERSION environment variable is required"
